...
if($_SERVER["REQUEST_METHOD"] == "POST") 
{
	if (isset($_POST["name"]) AND isset($_POST["last_name"]) AND isset($_POST["mail"]) AND isset($_POST["phone"]) AND isset($_POST["account_type"])) {
		...
		$reponse = $bdd->exec("INSERT INTO Utilisateur(id_utilisateur, nom, prenom, mail, password, telephone, type_compte, id_maison) VALUES (DEFAULT, $name, $last_name, $mail, $password_hash, $phone, $account_type, $id_house)");
