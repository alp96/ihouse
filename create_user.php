...
<body>
	...
	if ($donnees['type_compte'] == "Administrateur") {
		...
		<div id='wrap4'>
			...
			<div id="content">
				<form method="post" id='create_user' class="formulaire" action="create_user.php">
					...
					<div class="texte">ID maison</div>
					<input class="field" type="text" name="maison">
		...
		{
			if (isset($_POST["name"]) AND isset($_POST["last_name"]) AND isset($_POST["maison"]) AND isset($_POST["mail"]) AND isset($_POST["phone"]) AND isset($_POST["account_type"]) AND isset($_POST["genre"])) {
